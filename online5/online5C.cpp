...
class BST
{
    ...
    int Depthhelp(Node<E> *root, int item)
    {
        if (root == NULL)
        {
            return 0;
        ...
        if (item != root->data)
        {
            if (item < root->data)
            {
                return 1 + Depthhelp(root->left_child, item);
            }

            else if (item > root->data)
            {
                return 1 + Depthhelp(root->right_child, item);
            }
        }
